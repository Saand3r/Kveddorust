...
const password = (process.env.SERVERPW)

/**
 * @typedef {Object} ClassOptions
 * @property {string} [host='oslo14.spillvert.no'] Server port
 * @property {number} [port=28216] Server port
...
class SourceRCON {
  ...
  constructor(options = {}) {
     ...
     * @default '127.0.0.1'
     */
    this.host = options.host || 'oslo14.spillvert.no';
